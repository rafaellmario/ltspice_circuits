...
spicePath = 'C:\Program Files\ADI\LTspice'; % This is the path to your LT Spice installation
filePath = './'; %This is the path where you want the netlist, functions and simulation outputs to reside
netPath = './'; % THis is same as file path but all \ are replaced by \\ because of some Matlab issue in writing Netlist.
